...
<div class="content-wrap relative">
                    ...
                    <form id="" action="" method="">
                        <div class="form-wrap">
                            ...
                            <div class="input-content-wrap">
                                ...
                                <input type="text" id="" name="name" class="login-custom-input" placeholder="성명">
                            </div>
                            <div class="input-content-wrap">
                                <label for="user-name" class="input-label"></label>
                                <input type="text" id="" name="nickname" class="login-custom-input" placeholder="사용자 이름">
                            </div>
                            <div class="input-content-wrap">
                                <label for="password" class="input-label"></label>
                                <input type="password" id="" name="password" class="login-custom-input" placeholder="비밀번호">
                            </div>
                        </div>
                    </form>
                    <button type="submit" class="common-btn-login-form block pointer" formmethod="post" formaction="signup.php">가입</button>
    ...
    <div class="footer-navi">
        <ul class="navi-wrap">
            <li class="navi-content"><a href="#" class="block">INSTAGRAM 정보</a></li>
            <li class="navi-content"><a href="#" class="block">지원</a></li>
            <li class="navi-content"><a href="#" class="block">블로그</a></li>
            <li class="navi-content"><a href="#" class="block">홍보 센터</a></li>
            <li class="navi-content"><a href="#" class="block">API</a></li>
            <li class="navi-content"><a href="#" class="block">채용 정보</a></li>
            <li class="navi-content"><a href="#" class="block">개인정보처리방침</a></li>
            <li class="navi-content"><a href="#" class="block">약관</a></li>
