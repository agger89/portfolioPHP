...
$countArticle = $main->countArticle($users_id); // $articles 변수에 main 클래스에 소속된 articles 메소드를 담음
...
$currentPage = $main->articles($users_id, $limitIdx, $pageSet); // 현재 페이지 글 수
